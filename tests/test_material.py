...
LSHT_M = (
    6.941 * 3 / 8 + 87.62 * 7 / 16 + 178.49 * 1 / 4 + 180.95 * 3 / 4 + 15.999 * 3
) * 1.66053906660e-27
...
class TestMaterial:
    ...
    def test_v_avg_debye_over_snyder(self):
        ...
        mat = Material(
            ...
            density=5000,
            n_density=8e28,
            sound_velocity={"longitudinal": 5000, "transverse": 3000, "snyder_acoustic": 178},
        )
...
class TestMPIntegration:
    ...
    def test_from_mp_mock(self):
        ...
        print(f"MP STO: θ_D={mat.debye_temperature} K, v_avg={mat.v_avg} m/s, K={mat.K_vrh} GPa")
...
class TestBatchCahill:
    def test_batch_at_300K(self):
        materials = [
            Material("A", "A", density=5000, n_density=8e28, sound_velocity={"average": 3000}),
            Material("B", "B", density=3000, n_density=5e28, sound_velocity={"average": 2000}),
        ]
    ...
    def test_batch_array_T(self):
        materials = [
            Material("X", "X", density=5000, n_density=8e28, sound_velocity={"average": 3000}),
        ]
